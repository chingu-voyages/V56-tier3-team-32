...
step1: Clone this repo in your local system
step2: visit frontend and backend folder and run 
'''cd backend
npm install
...
step3: create environment variable( for these secret keys)
- PORT=
- SURGERY_DATABASE_CONNECTION_CREDENTIALS=

step4: open two terminal one for backend, another for frontend & run in both terminal
'''npm run dev